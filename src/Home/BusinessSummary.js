    ...
    return (
        <div className='mt-9 items-center'>
            <div className="text-center">
                <h3 className="text-3xl">Buisness summary</h3>
            </div>
            <div className='grid justify-center'>
                <div className="stats stats-vertical lg:stats-horizontal shadow ">
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-desc">Growing at (22%)</div>
                    </div>
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-desc">4.5 star</div>
                    </div>
                    <div className="stat">
                        <div className="stat-figure text-secondary">
                        ...
                        <div className="stat-desc">daily manufacturing more and more</div>
                    </div>
