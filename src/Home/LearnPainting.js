    ...
    return (
        <div className="hero min-h-screen bg-base-200 mt-9">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src="https://img.freepik.com/free-vector/artistic-background-with-palette-paints_1284-10291.jpg?t=st=1653421634~exp=1653422234~hmac=ae9e707a967d2db9e9df10a0ac321d45bb97e531938c16bbe1021e1d7d00a394" className="max-w-sm rounded-lg shadow-2xl" alt='painting' />
                <div>
